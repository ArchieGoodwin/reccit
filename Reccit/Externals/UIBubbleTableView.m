...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSLog(@"%i   %i", self.bubbleSection.count, indexPath.section );
    if(self.bubbleSection.count == (indexPath.section + 1))
    {
        if(indexPath.row == (((NSMutableArray *)[self.bubbleSection objectAtIndex:indexPath.section]).count - 1))
        {
            cell.selected  = YES;
        }
    }
